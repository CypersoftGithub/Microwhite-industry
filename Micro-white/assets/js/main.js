(function($) {
    ...
    $(".hero-small-slider .small-thumb,.work-process-items-3, .choose-list li,.service-concept-box ").hover(
		// Function to run when the mouse enters the element
		function () {
			// Remove the "active" class from all elements
			$(".hero-small-slider .small-thumb,.work-process-items-3, .choose-list li,.service-concept-box ").removeClass("active");
